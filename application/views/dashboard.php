        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <div class="sidebar-brand-text mx-3">SIKERMA</div>
            ...
            <li class="nav-item">
                ...
                <i class="bi bi-mortarboard-fill"></i>
                    <span>Pengajuan Kerja Sama</span></a>
            </li>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Pengajuan PBL</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $totalPBL = 0;
                                                foreach ($lstpengajuan as $item) {
                                                    if ($item->tipepengajuan == "PBL") {
                                                        $totalPBL++;
                                                    }
                                                }
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Pengajuan Magang</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $totalMagang = 0;
                                                foreach ($lstpengajuan as $item) {
                                                    if ($item->tipepengajuan == "Magang") {
                                                        $totalMagang++;
                                                    }
                                                }
                                        ...
                                        <div class="col-auto">
                                            <i class="bi bi-person text-gray-300" style="font-size: 3rem;"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                ...
                                                $totalKerjaSama = 0;
                                                foreach ($lstpengajuan as $item) {
                                                    if ($item->tipepengajuan == "KerjaSama") {
                                                        $totalKerjaSama++;
                                                    }
                                                }
