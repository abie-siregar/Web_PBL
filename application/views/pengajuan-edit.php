            ...
            <div class="card shadow mb-4">
              <div class="card-body">
                <div class="table-responsive">
                  <form class="user" action="<?= base_url('index.php/Pengajuan/ubah?id='. $pengajuan[0]->id) ?>" method="POST">
                    <div class="form-group">
                      <input type="text" name="id" id="id" class="form-control form-control-user" placeholder="ID" 
                        value="<?= $pengajuan[0]->id; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <input type="text" name="tipepengajuan" id="tipepengajuan" class="form-control form-control-user" placeholder="Tipe Pengajuan"
                      value="<?= $pengajuan[0]->tipepengajuan; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <input type="text" name="deskripsi" id="deskripsi" class="form-control form-control-user" placeholder="Deskripsi"
                      value="<?= $pengajuan[0]->deskripsi; ?>">
                    </div>
                    <?php $formattedDate = date('Y-m-d', strtotime($pengajuan[0]->tglpengajuan)); ?>
                    <div class="form-group">
                      <input type="date" name="tglpengajuan" id="tglpengajuan" class="form-control form-control-user" placeholder="Tanggal Pengajuan"
                      value="<?= $formattedDate; ?>">
                    </div>
                    <div class="form-group">
                      <input type="text" name="status" id="status" class="form-control form-control-user" placeholder="Status"
                      value="<?= $pengajuan[0]->status; ?>" disabled>
                    </div>
