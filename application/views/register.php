            ...
            <div class="row">
                ...
                <div class="col-lg-5 mx-5 my-5">
                    <div class="card rounded-5 shadow">
                        ...
                        <form class="m-4" action="<?= base_url('index.php/register/tambah') ?>" method="POST">
                            <!-- Username -->
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary w-100 text-light border-1 ">Daftar</button>
                                <br>
                                <br>
                                
                        </form>
                        <span class=" me-3 ">Sudah mempunyai akun ?</span>
                                <a href="<?= site_url('login'); ?>" class="btn btn-primary btn-sm">Masuk</a>
                    </div>
                </div>
            </div>
        </div>
